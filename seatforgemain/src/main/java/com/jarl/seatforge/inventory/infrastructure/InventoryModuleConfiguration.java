...
import com.jarl.seatforge.inventory.application.usecase.GetReservationForOrderHandler;
...
public class InventoryModuleConfiguration {
    ...
    @Bean
    GetReservationForOrderUseCase getReservationForOrderUseCase(OrderReservationStore store) {
